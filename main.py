...
assumptions
1. Согласно моей интерпритации тз, все операции по фильтрации, агрегации и т.п., кроме подстановки даты, должны быть сделаны при помощи SQL
2. Рассылки по регистрации и по активности - 2 разные сущности с независимыми условиями отправки, так что одному пользователю может быть отправлено что-то одно, или оба сообщения сразу.
